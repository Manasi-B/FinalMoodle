...
public class Assignments extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView it_assignmentScreen = (TextView) findViewById(R.id.link_to_it_assignment);
        ...
        it_assignmentScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), ITAssignment.class);
                startActivity(i);
            }
        });
        
        TextView comps_assignmentScreen = (TextView) findViewById(R.id.link_to_comps_assignment);
        ...
        comps_assignmentScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), CompsAssignment.class);
                startActivity(i);
            }
        });
