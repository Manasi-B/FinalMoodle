...
public class Syllabus extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView activity_itScreen = (TextView) findViewById(R.id.link_to_it_syllabus);
 
        // Listening to register new account link
        activity_itScreen.setOnClickListener(new View.OnClickListener() {
 
            public void onClick(View v) {
                // Switching to IT screen
                Intent i = new Intent(getApplicationContext(), ITSyllabus.class);
                startActivity(i);
            }
        });
        
        TextView activity_compsScreen = (TextView) findViewById(R.id.link_to_comps_syllabus);
        
        // Listening to forget password link
        activity_compsScreen.setOnClickListener(new View.OnClickListener() {
 
            public void onClick(View v) {
                // Switching to forget screen
                Intent i = new Intent(getApplicationContext(), CompsSyllabus.class);
                startActivity(i);
            }
        });
